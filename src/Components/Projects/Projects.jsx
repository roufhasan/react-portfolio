...
const Projects = () => {
  return (
    ...
    >
      ...
      <h2 className="text-6xl font-bold text-center mt-5 mb-[120px] text-[#292930] leading-relaxed">
      ...
      <div>
        ...
        {/* --- Toy Verse Project --- */}
        <div className="flex flex-col-reverse lg:flex-row gap-24 items-center shadow-custom3 rounded-2xl p-5 my-14">
          <div className="text-center w-full lg:w-[45%]">
            <h4 className="uppercase mb-5 font-bold text-xl text-[#292930]">
              Toy Verse 🚀
            </h4>
